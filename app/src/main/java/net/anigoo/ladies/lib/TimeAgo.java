...
public class TimeAgo {
	...
	private String suffixAgo = getMessages("TimeAgo.AGO"); //$NON-NLS-1$

	private String suffixFromNow = getMessages("TimeAgo.SUFFIX_FROM_NOW"); //$NON-NLS-1$

	private String seconds = getMessages("TimeAgo.SECONDS"); //$NON-NLS-1$

	private String minute = getMessages("TimeAgo.MINUTE"); //$NON-NLS-1$

	private String minutes = getMessages("TimeAgo.MINUTES"); //$NON-NLS-1$

	private String hour = getMessages("TimeAgo.HOUR"); //$NON-NLS-1$

	private String hours = getMessages("TimeAgo.HOURS"); //$NON-NLS-1$

	private String day = getMessages("TimeAgo.DAY"); //$NON-NLS-1$

	private String days = getMessages("TimeAgo.DAYS"); //$NON-NLS-1$

	private String month = getMessages("TimeAgo.MONTH"); //$NON-NLS-1$

	private String months = getMessages("TimeAgo.MONTHS"); //$NON-NLS-1$

	private String year = getMessages("TimeAgo.YEAR"); //$NON-NLS-1$

	private String years = getMessages("TimeAgo.YEARS"); //$NON-NLS-1$
	...
	public static String getMessages(String key) {
            ...
            switch (key) {
                ...
                case "TimeAgo.MONTHS":
                    message = "{0} tháng";
                    break;
                case "TimeAgo.SECONDS":
                    message = "vài giây";
                    break;
                case "TimeAgo.SUFFIX_FROM_NOW":
                    message = "trước";
                    break;
                case "TimeAgo.YEAR":
                    message = "một năm";
        ...
        public static void main(String[] args) throws ParseException {
            ...
            System.out.println(time.timeAgo(new Date()));
